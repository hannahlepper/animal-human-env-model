...
eq_analysis_bounded <- unlist(read_csv("M:/New projects/Model env compartment/outcomeequilibriumBounded.csv", 
                               col_names = FALSE))
eq_analysis_unbounded <- unlist(read_csv("M:/New projects/Model env compartment/outcomeequilibriumUnbounded.csv", 
                               col_names = FALSE))
...
p <- ggplot(df.equilibrium_bounded, aes(parameter, value))
p <- ggplot(df.equilibrium_unbounded, aes(parameter, value))
